...
const FALLBACK_TO_JSD = new Set(["sonarqube", "oracle", "visualstudiocode", "linkedin", "openai"]);
                        ...
                        {category.items.map((item) => (
                          ...
                          >
                            <Icon
                              ...
                              alt={item.alt}
                              className={
                                ["nextdotjs", "shadcnui", "express", "prisma", "knex", "oracle", "sonarqube", "visualstudiocode", "github", "openai"].includes(
                                  item.icon
                                )
