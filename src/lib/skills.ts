...
const skills: SkillCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "shadcn/ui", icon: "shadcnui", alt: "shadcn/ui", url: "https://ui.shadcn.com/" },
      { name: "Material Design", icon: "materialdesign", alt: "Material Design", url: "https://m3.material.io/" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Knex", icon: "knexdotjs", alt: "Knex", url: "https://knexjs.org/" },
